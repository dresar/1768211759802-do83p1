...
const gameThumbPath = path.join(assetsPath, 'games.jpg')
const rpgThumbPath = path.join(assetsPath, 'rpg.jpg')
const winnerThumbPath = path.join(assetsPath, 'winner.jpg')
...
function getRpgContextInfo(title = '⚔️ RPG ADVENTURE', body = 'Adventure awaits!') {
