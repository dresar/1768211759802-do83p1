...
try {
    if (fs.existsSync('./assets/images/thumbnail2.jpg')) {
        cachedThumb = fs.readFileSync('./assets/images/thumbnail2.jpg')
    }
} catch (e) {}
            ...
            try {
                if (mediaBuffer) {
                    ...
                    await sock.sendMessage(groupId, { text: text, contextInfo: {
                            ...
                            isForwarded: true,
                            externalAdReply: cachedThumb ? {
                                title: config.bot?.name || 'Invywed Bot',
                                body: 'Invywed Bot WhatsApp',
                                thumbnail: cachedThumb,
                                sourceUrl: '',
                                mediaType: 1,
                                renderLargerThumbnail: false
